...
int main(int argc, const char** argv)
{
    ...
    objl::Loader Loader;
    std::string obj_path = "E://game_make/work_space/games101_graphics/mission3/models/spot/";

    // Load .obj File
    bool loadout = Loader.LoadFile("E://game_make/work_space/games101_graphics/mission3/models/spot/spot_triangulated_good.obj");
